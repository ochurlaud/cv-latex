...
\begin{minipage}{\linewidth}
	...
	~
		...
		\begin{tabular}{p{\datescale\linewidth} P{\descripscale\linewidth}}
			\itemcv{2014 -- 2016}{TU Berlin : Master Électrotechnique, spécialité \textit{Systèmes de Communication}}
		...
		\begin{tabular}{p{\datescale\linewidth} P{\descripscale\linewidth}}
			\itemcv{Management}{Chef de projet, coordination d'équipes}
			\itemcv{Sciences}{Traitement du signal, Filtrage, Électromagnétisme, Mathématiques, Channel et Source coding}
			\itemcv{Informatique}{
			...
			\itemcv{Langues}{
				...
				\textbf{Allemand} Lu, écrit, parlé : B2 {\scriptsize(Système de notation Européen, 2015)}. À Berlin depuis 12 mois.
			}
