...
\begin{minipage}{\linewidth}
	...
	~
		...
		\begin{tabular}{p{\datescale\linewidth} P{\descripscale\linewidth}}
			\itemcv{Mai-Aug. 2014}{
				\textbf{Forschungpraktikum mit F.~P.~Andriulli (Telecom Bretagne)}\\
		...
		\begin{tabular}{p{\datescale\linewidth} P{\descripscale\linewidth}}
			...
			\itemcv{Elektrotechnik}{Informationstheorie, Codierungstheorie (Quellen- und Kanalcodierung), Signalverarbeitung, Elektromagnetismus}
			\itemcv{Informatik}{
			...
			\itemcv{Sprache}{
				...
				europäischen Referenznahmens: 12 Jahre, Seit 9 Monate in Berlin)
			}
...
\begin{minipage}[t]{150pt}
	 ...
	 \place, den \today,
\end{minipage}
\IfFileExists{img/signature.png}{
